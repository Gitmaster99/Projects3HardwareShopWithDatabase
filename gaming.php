            ...
            <div class="navbar-nav">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="prebuilds.php" class="dropdown-item">All Prebuilds</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="accessories.php" class="dropdown-item">All Accessories</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="components.php" class="dropdown-item">All Components</a>
...
<div class="container-fluid top-section">
    <div class="row">
        ...
        *Some of the components may not match exact model pictured.
        ...
        <h1 class="text-black">Epic-Bld Custom 3980 Gaming PC</h1>
        <h3>€1799 Euro</h3>
        <p>Thanks to our co-operation with NZXT and Asus we can present you the ultimate gaming performance powerhouse for a very
          good price.
        </p>
        <p class="text-black m-t">Do you want a good performing desktop computer, like to game a lot and have a bigger budget?</p>

        <p>Then step up your game with our Epic-Bld Gaming PC boasting an AMD Ryzen 7 3700x eight core CPU, NVIDIA GeForce
          RTX 2080 Super Graphics,
          and 16 gb of high performance DDR4 memory.</p>
        <p class="text-black m-t">Save €170 when subscribing to our <a href="newsletter.html">newsletter</a>.</p>
          ...
          <div class="container  container-specs align-right">
            ...
            <div class="row">
              <div class="col-md-2">
                ...
                <div class="col-md-8">
                <p>Step up your work with our amazing looking and performing Epic-Bld Custom 3980 Gaming PC.</p>
                <p>Get serious work done with AMD's Ryzen 7 3700x eight core CPU. At a TDP off 65W, this CPU can be kept cool quiete easily, 
                  so you can get the best performance while keeping your components cool. with it's eight cores and 16 Threads, you can be sure of very good performance, especially in demanding games.</p> 
                  <p>Paired with 16Gb of blazing fast 3600Mhz RAM and a fast 1Tb NVME SSD from Samsung, you're computer loads every application or program blazing fast.</p>
                  <p>Done gaming? Do you like to do some light photo editing or maybe some light video editing? Thanks to a very capable NVIDIA GeForce RTX™ 2080 Super with 8GB of GDDR6 
                    Video Memory, you can, combined with your CPU horsepower, edit some photo's or edit some 1080p video quiete smoothly.</p>
                  <p>Thanks to the ROG Strix X570-E Gaming ATX AM4 Motherboard and the NZXT H510 Elite Wit ATX Case, you have a large selection 
                    off ports to connect you favorite peripherals.</p>
                  <p>All in all, The Epic-Bld Custom 3980 Gaming PC is an all-round monster when it 
                    comes to getting work done and also gaming, when you have a little more to spend.</p>
...
<td>GPU</td>
<td>NVIDIA GeForce RTX™ 2080 Super 8GB</td>

</tr>
<tr>

<td>DRAM</td>
<td>2 x 8GB CORSAIR VENGEANCE RGB PRO DDR4-3600</td>

</tr>
<tr>

<td>Cooling</td>
<td>Water cooling CPU, Air GPU</td>

</tr>
<tr>

<td>Storage</td>
<td>Samsung 970 EVO 1TB M.2 NVME Solid State Drive</td>
...
<td>Motherboard</td>
<td>ROG Strix X570-E Gaming ATX AM4 Motherboard</td>

</tr>
<tr>

  <td>Computer Case</td>
  <td>NZXT H510 Elite White ATX Case</td>
...
<td>Networking</td>
<td>Intel® I211-AT Gigabit LAN, Intel® Wi-Fi 6 AX200</td>

</tr>
<tr>

<td>Power Supply</td>
<td>RMx Series™ RM850x — 850 Watt 80 PLUS® Gold Certified Fully Modular PSU</td>

</tr>
<tr>

<td>External Connections</td>
<td>FRONT: 1x USB 3.1 Gen 2 Type C, 1x USB 3.1 Gen 1, Headphone/Mircophone Combo Jack<br><br>REAR: ‧1x HDMI 2.0, 
  ‧ 1x DisplayPort 1.2, 7x USB 3.2 Gen 2 Type A, 1x USB 3.2 Gen 2 Type C, Intel® I211-AT Gigabit LAN, Intel® Wi-Fi 6 AX200, audio, PS/2, 3x DisplayPort , 1x HDMI
  </td>
