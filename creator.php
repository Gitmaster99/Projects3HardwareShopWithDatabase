...
<div class="container-fluid top-section">
    <div class="row">
        ...
        *Some of the components may not match exact model pictured.
        ...
        <h1 class="text-black">Epic-Bld Custom 5980 Creator PC</h1>
          <h3>€2599 Euro</h3>
          <p>Thanks to our co-operation with NZXT, Corsair and Asus we can present you the ultimate content creating
            performance powerhouse for a very
            good price.
          </p>
          <p class="text-black m-t">Do you want a good performing desktop computer, like to create a lot and have big
            money to spend?</p>

          <p>Then step up your game with our Epic-Bld Creator PC boasting an AMD Ryzen 9 3950x 16 core CPU, NVIDIA
            GeForce
            RTX 2080ti Graphics,
            and 32 gb of high performance DDR4 memory.</p>
          <p class="text-black m-t">Save €250 when subscribing to our <a href="newsletter.html">newsletter</a>.</p>
...
<div class="container">
        <div class="row ">
          <div class="col-md-6">
          <img class="mx-auto d-block" src="images/icons8-processor-50.png">
          <h3 class="text-center">PROCESSOR</h3>
          <p class="text-center">AMD Ryzen 9 3950x</p><br>

          <img class="mx-auto d-block" src="images/icons8-memory-slot-50.png">
          <h3 class="text-center">MEMORY</h3>
          <p class="text-center">32GB CORSAIR VENGEANCE RGB PRO DDR4-3733</p><br>

          <img class="mx-auto d-block" src="images/icons8-motherboard-50.png">
          <h3 class="text-center">MOTHERBOARD</h3>
          <p class="text-center">Asus ROG Crosshair VIII Formula X570 AM4 Motherboard
          </p>
        ...
        <div class="col-md-6">
          ...
          <p class="text-center">NVIDIA GeForce RTX™ 2080ti 11 GB GDDR6</p><br>

          <img class="mx-auto d-block" src="images/icons8-ssd-50.png">
          <h3 class="text-center">STORAGE</h3>
          <p class="text-center">Samsung 970 PRO 2TB M.2 NVME Solid State Drive</p><br>

          <img class="mx-auto d-block" src="images/icons8-server-50.png">
          <h3 class="text-center">COMPUTER CASE</h3>
          <p class="text-center">Lian Li PC-O11WXC Midtower E-ATX Case</p>
          ...
          <div class="container  container-specs align-right">
            ...
            <div class="row">
              <div class="col-md-2">
                ...
                <div class="col-md-8">
                <p>Step up your work with our amazing looking and performing Epic-Bld Custom 5980 Creator PC.</p>
              <p>Get serious work done with AMD's Ryzen 9 3950x 16 core CPU. At a TDP off 105W, this CPU need some
                serious cooling
                to keep it running smooth, therefore there is
                an option to equipe your PC with Corsair's custom water cooling components.
                This to make sure that you can get the best performance while keeping your components cool. with it's
                16 cores and
                32 Threads, you can be sure of very good performance, especially in tasks that demand a lot of cores.
              </p>
              <p>Paired with 32Gb of blazing fast 3733Mhz RAM and a fast 2Tb NVME SSD from Samsung, you're computer
                loads every
                application or program blazing fast.</p>
              <p>Done creating? Do you like to do some gaming or maybe just some everyday tasks? Thanks to a very
                capable NVIDIA
                GeForce RTX™ 2080ti with 11GB of GDDR6
                Video Memory, you can, combined with your CPU horsepower, you can get almost everything done.</p>
              <p>Thanks to the Asus ROG Crosshair VIII Formula X570 AM4 Motherboard, the top of the line when it comes
                to X570 AM4
                Motherboards, and the Lian Li PC-O11WXC Midtower E-ATX Case, you have a large selection
                off ports to connect you favorite peripherals.</p>
              <p>All in all, The Epic-Bld Custom 5980 Creator PC is an all-round monster when it
                comes to getting work done and also gaming, when you have a ton of to spend.</p>
...
<td>GPU</td>
<td>NVIDIA GeForce RTX™ 2080ti 11GB</td>

</tr>
<tr>

<td>DRAM</td>
<td>4 x 8GB CORSAIR VENGEANCE RGB PRO DDR4-3733</td>

</tr>
<tr>

<td>Cooling</td>
<td>Water Cooling CPU, Water Cooling GPU</td>

</tr>
<tr>

<td>Storage</td>
<td>Samsung 970 Pro 2TB M.2 NVME Solid State Drive</td>
...
<td>Motherboard</td>
<td>Asus ROG Crosshair VIII Formula X570 AM4 Motherboard</td>

</tr>
<tr>

<td>Computer Case</td>
<td>Lian Li PC-O11WXC Midtower E-ATX Case</td>
...
<td>Networking</td>
<td>Aquantia AQC-111 5G LAN, Intel®​ I211-AT Gb LAN, Intel® Wi-Fi 6 AX200</td>

</tr>
<tr>

<td>Power Supply</td>
<td>RMx Series™ RM1000x — 1000 Watt 80 PLUS® Gold Certified Fully Modular PSU</td>

</tr>
<tr>

<td>External Connections</td>
<td>FRONT: 1x USB 3.1 Gen 2 Type C, 2x USB 3.1 Gen 2, Headphone/Mircophone Combo
  Jack<br><br>REAR: ‧1x HDMI 2.0,
  ‧ 1x DisplayPort 1.2, 7x USB 3.2 Gen 2 Type A, 1x USB 3.2 Gen 2 Type C, Aquantia AQC-111 5G
  LAN, Intel®​ I211-AT Gb LAN, Intel® Wi-Fi 6 AX200, audio, PS/2, 3x DisplayPort , 1x HDMI
</td>
